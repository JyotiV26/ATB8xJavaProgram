...
public class Lab074 {
    public static void main(String[] args) {
        ...
        // 1. Find the user Inputs and data type should be given by Interviewer
        // input - score -> int score = 89 ;
        ...
        if (score >= 90 && score <= 100) {
            ...
            grade = 'D';
        } else if (score <= 0 || score > 100) { //to handle invalid inputs from user (negative test case)
